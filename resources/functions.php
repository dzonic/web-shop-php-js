...
<div class="col-sm-4 col-lg-4 col-md-4">
    <div class="thumbnail">
        ...
        <div class="caption">
            <h4 class="pull-right">{$row['product_price']} &nbsp RSD</h4>
            <h4><a href="item.php?id={$row['product_id']}">{$row['product_title']}</a>
            </h4>
            <p>Detalje za proizvod možete videti klikom na proizvod</p>
...
$product = <<<DELIMETER
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>{$row['product_title']}</h3>
                        <p>Za dodatne detalje proizvoda klikni na više informacija.
                        </p>
                        <p>
                            <a href="../resources/cart.php?add={$row['product_id']}" class="btn btn-primary">Kupi sada!</a> <a href="item.php?id={$row['product_id']}" class="btn btn-default">Više informacija</a>
                        </p>
                    </div>
                </div>
            </div>
...
set_message("Vaše korisničko ime i lozinka su pogresno uneti");
redirect("login.php");
